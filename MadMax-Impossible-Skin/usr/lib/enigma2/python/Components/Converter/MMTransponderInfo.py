...
class MMTransponderInfo(Converter):
		...
		if transponderraw:
			...
			try:
				if "DVB-T" in transponderdata["system"]:
					return "%s %s %s %s %s-%s" % (transponderdata["system"], transponderdata["channel"], transponderdata["frequency"] // 1000, transponderdata["bandwidth"], tsid, onid)
				...
				return "%s %s %s %s %s %s %s-%s %s" % (transponderdata["system"], transponderdata["frequency"] // 1000, transponderdata["polarization_abbreviation"], transponderdata["symbol_rate"] // 1000,
