...
satnames = (
	...
	(171.7, 172.3, "Eutelsat 172A,172B"),
	(168.7, 169.3, "Intelsat 805"),
	(165.7, 166.3, "Intelsat 19"),
	(163.7, 164.3, "Optus 10"),
	(161.7, 162.3, "Superbird B2/JCSat 16"),
	(159.7, 160.3, "Optus D1"),
	(158.7, 159.3, "ABS 6"),
	(155.7, 156.3, "Optus C1,D3"),
	(153.7, 154.3, "JCSat 2B"),
	(151.7, 152.3, "Optus D2"),
	(149.7, 150.3, "JCSat 1B"),
	(143.7, 144.3, "Superbird C2"),
	(141.7, 142.3, "Apstar 9"),
	(139.7, 140.3, "Express AM5,AT2"),
	(137.7, 138.3, "Telstar 18"),
	(135.7, 136.3, "JCSat 2A"),
	(133.7, 134.3, "Apstar 6"),
	(130.7, 132.3, "Vinasat 1,2/JCSat 5A"),
	(128.4, 128.8, "LaoSat 1"),
	(127.8, 128.3, "JCSat 3A"),
	(124.8, 125.3, "ChinaSat 6A"),
	(123.8, 124.3, "JCSat 4B"),
	(120.8, 122.5, "AsiaSat 4"),
	(119.8, 120.3, "AsiaSat 6/Thaicom 7"),
	(119.4, 119.7, "Thaicom 4"),
	(118.8, 119.3, "Bangabandhu 1"),
	(117.8, 118.3, "Telkom 3S"),
	(115.8, 116.3, "ABS 7/KoreaSat 6,7"),
	...
	(93.0, 93.8, "Insat 4B/G-Sat 15"),
	(92.0, 92.5, "ChinaSat 9"),
	(91.3, 91.8, "Measat 3A,3B"),
	(88.8, 90.3, "Yamal 401"),
	(87.8, 88.3, "ST 2"),
	...
	(-2.7, -3.3, "ABS 3A"),
	(-3.7, -4.2, "Amos 3,7"),
	(-4.3, -4.4, "Amos 3,7/Thor 3"),
	(-4.7, -5.4, "Eutelsat 5WA,5WB"),
	...
	(-66.7, -67.5, "SES 10/AMC 4,6"),
	(-69.7, -70.3, "Star One C2,C4"),
	(-71.5, -71.8, "Arsat 1"),
	(-72.0, -72.3, "Arsat 1/AMC 3"),
	(-72.4, -72.8, "Nimiq 5"),
	(-74.7, -75.3, "Star One C3"),
	(-76.7, -77.3, "QuetzSat 1"),
	(-77.7, -78.3, "Simón Bolívar"),
	(-78.5, -79.2, "Sky Mexico 1"),
	(-80.7, -81.3, "Arsat 2"),
	(-81.7, -82.3, "Nimiq 4"),
	(-82.7, -83.3, "AMC 9"),
	(-83.6, -83.9, "Hispasat 84W-1"),
	(-84.0, -84.3, "Star One D1"),
	(-84.7, -85.5, "AMC 16/Sirius XM3,XM5"),
	(-86.0, -86.5, "Sirius FM5"),
	...
	(-100.7, -101.4, "SES 1/DirecTV 8,4S"),
	(-102.5, -102.8, "DirecTV 15"),
	(-102.9, -103.4, "SES 3/DirecTV 10,12"),
	(-104.7, -105.4, "AMC 15,18/SES-11"),
	(-106.8, -107.1, "EchoStar 17"),
	(-107.2, -107.6, "Anik F1R,G1"),
	(-108.8, -109.5, "Telstar 12"),
	(-109.7, -110.4, "EchoStar 10,12/DirecTV 5"),
	(-110.8, -111.5, "Anik F2"),
	(-112.7, -113.4, "Eutelsat 113 West A"),
	(-114.6, -114.8, "Mexsat Bicentenario"),
	(-114.9, -115.4, "Eutelsat 115 West B"),
	(-116.6, -117.4, "Eutelsat 117 West A,B"),
	(-118.7, -119.4, "Anik F3/DTV 75/EchoStar 14"),
	(-120.7, -121.4, "EchoStar 9/Galaxy 23"),
	(-122.7, -123.4, "Galaxy 18"),
	(-124.7, -125.4, "AMC 21/Galaxy 14"),
	(-126.7, -127.4, "Galaxy 13/Horizons 1"),
	(-128.7, -129.4, "Ciel 2/Galaxy 12"),
	(-130.7, -131.4, "AMC 11"),
...
class MMBaseInfo(Poll, Converter, object):
	FREQINFO = 0
	ORBITAL = 1
	RESCODEC = 2
	PIDINFO = 3
